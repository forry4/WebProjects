...
Usage:
    python -m games.spender.ai.offline.h2_tune --opp h2 --games 1600           # self-gate sanity (~0.5)
    python -m games.spender.ai.offline.h2_tune --opp h2 --sweep W_GOLD 0.3 0.4 0.5 0.6
    python -m games.spender.ai.offline.h2_tune --opp h2 --set V.ENG_DECK_W=4.0 H.NOBLE_SCALE=3.5
"""
...
from ..serving import heuristic as H_BASE      # variant H (opponent for --opp H)
from ..serving import heuristic2 as H          # variant H2 (the bot we tune)
from ..serving import valuation2 as V
