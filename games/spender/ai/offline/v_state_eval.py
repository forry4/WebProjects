...
Usage:
    python -m games.spender.ai.offline.v_state_eval --teacher S --games 240 --sims 256 --workers 12
    python -m games.spender.ai.offline.v_state_eval --teacher H3 --games 200 --opps H3,H2,H2N,H2R
"""
...
from ..serving.mcts import Search
