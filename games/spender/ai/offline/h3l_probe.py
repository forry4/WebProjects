...
Usage:
    python -m games.spender.ai.offline.h3l_probe --n 80 --workers 10 --mode rollout
    python -m games.spender.ai.offline.h3l_probe --n 200 --workers 10 --mode static --opps H3,H2,H2N,H2R
"""
