...
Usage:
    python -m games.spender.ai.offline.vsearch_camp --n 200 --workers 12 --sims 200 --opps H3,H2,H2N,H2R
    python -m games.spender.ai.offline.vsearch_camp --n 120 --sims 160 --set W_PROGRESS=2.0 SCALE=7
"""
