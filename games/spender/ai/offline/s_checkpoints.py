...
CLI:
  python -m games.spender.ai.offline.s_checkpoints save <name> [--note "..."]
  python -m games.spender.ai.offline.s_checkpoints list
  python -m games.spender.ai.offline.s_checkpoints show <name>
"""
