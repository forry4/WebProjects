...
Usage:
  python -m games.spender.ai.offline.bootstrap_harvest --games 400 --sims 256 --workers 12 \
...
from ..serving.distill_features import feat_enriched  # noqa: E402
    ...
    for i in range(lo, hi):
        ...
        if s.phase == E.OVER and s.winner != E.WIN_DRAW:
            for feats, vsv, pi, mask, seat, gid in recs:
                ...
                GID.append(gid)
    if not X:
        from ..serving.distill_features import ENRICHED_F
