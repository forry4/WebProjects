...
Usage:
    python -m games.spender.ai.offline.az_vs_h2 --games 100 --az-sims 300
    python -m games.spender.ai.offline.az_vs_h2 --games 100 --az-sims 300 --set W_TEMPO=0.4 W_GEM=0.3
"""
...
def _load_evaluator(path: str, device: str = "cpu"):
    if path.endswith(".npz"):
        from ..serving.infer_np import load_evaluator
