...
Usage:
    python -m games.spender.ai.offline.h3_vs_h2 --games 200 --potential
    python -m games.spender.ai.offline.h3_vs_h2 --games 200 --potential --set POT_REACH_W=0.5 POT_ENGINE_W=1.5
    python -m games.spender.ai.offline.h3_vs_h2 --games 200 --potential --set W_TEMPO=0.4 W_GEM=0.3
"""
...
from ..serving import heuristic as H1
from ..serving import heuristic2 as H2
from ..serving import heuristic3 as H3
from ..serving import valuation3 as V3
