...
Run:  python -m games.spender.ai.offline.h2_autotune
"""
...
from ..serving import heuristic2 as H   # noqa: F401  (ensures workers load the module graph)
from ..serving import valuation2 as V   # noqa: F401
