...
Usage:
  python -m games.spender.ai.offline.net_vs_s --npz games/spender/ai/az/checkpoints_bootstrap/az_bootstrap.npz \
...
from ..serving.infer_np import load_evaluator   # noqa: E402
