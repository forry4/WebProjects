...
Run:  python -m games.spender.ai.offline.h3_fp_sweep
      python -m games.spender.ai.offline.h3_fp_sweep --screen-n 800 --fresh-n 2000 --workers 10
"""
...
from ..serving import heuristic as H1   # noqa: F401  (ensures the module graph loads in workers)
from ..serving import heuristic2 as H2  # noqa: F401
from ..serving import heuristic3 as H3  # noqa: F401
from ..serving import valuation3 as V3  # noqa: F401
