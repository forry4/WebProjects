...
Usage:
  python -m games.spender.ai.offline.config_selfgate --sims 160 --n 140 --workers 12 \
...
from ..serving import v_state
from ..serving import valuation3 as V3
from ..serving import vsearch
...
_PROBE_KEYS = ["PRIOR_UNIFORM", "POLICY_TEMP", "C_PUCT", "BACKUP_LAMBDA", "BACKUP_MIN_VISITS",
               ...
               "ENGINE_STOCK_BOARD_W", "W_ENGINE_STK"]  # v_state (durable board-coverage engine term + its magnitude)
FROZEN: dict = {}
