...
socket claiming the OPPONENT's pid. Rag Tag redacts state PER RECIPIENT, and what
that redaction protects is the entire game: your Fight Deck's ORDER is very
nearly all the hidden information there is. An unproven socket handed that seat's
view would see exactly which card is coming next, for the rest of the fight.

These pin the rule that a socket must PROVE ownership of its pid before it can
act as that seat or receive that seat's view. Mirrors the six games that already
