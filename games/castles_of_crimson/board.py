...
#              L=livestock(green) B=building(beige) Y=monastery(yellow)
#
...
_CODE2COLOR = {"C": "burgundy", "S": "blue", "M": "gray", "L": "green", "B": "beige", "Y": "yellow"}
...
_BOARD_ROWS: dict[str, tuple[str, list[list[tuple[str, int]]]]] = {
    "1": ("Starter", [
        [("L", 6), ("C", 5), ("C", 4), ("Y", 3)],
        [("L", 2), ("L", 1), ("C", 6), ("Y", 5), ("B", 4)],
        [("L", 5), ("L", 4), ("B", 3), ("Y", 1), ("B", 2), ("B", 3)],
        [("S", 6), ("S", 1), ("S", 2), ("C", 6), ("S", 5), ("S", 4), ("S", 1)],
        [("B", 2), ("B", 5), ("M", 4), ("B", 3), ("B", 1), ("L", 2)],
        [("B", 6), ("M", 1), ("Y", 2), ("B", 5), ("B", 6)],
        [("M", 3), ("Y", 4), ("Y", 1), ("B", 3)],
    ]),
    "2": ("Big City", [   # 2019-edition layout (extracted from BGA)
        [("Y", 6), ("Y", 5), ("Y", 4), ("C", 3)],
        [("B", 2), ("B", 1), ("S", 6), ("L", 5), ("M", 4)],
        [("M", 5), ("B", 4), ("B", 3), ("S", 1), ("L", 2), ("S", 3)],
        [("C", 6), ("B", 1), ("S", 2), ("C", 6), ("Y", 5), ("B", 4), ("S", 1)],
        [("Y", 2), ("S", 5), ("B", 4), ("L", 3), ("Y", 1), ("B", 2)],
        [("B", 6), ("B", 1), ("L", 2), ("B", 5), ("M", 6)],
        [("L", 3), ("L", 4), ("B", 1), ("C", 3)],
    ]),
    "3": ("Ring of Knowledge", [
    ...
    "4": ("Twin Cities", [   # 2019-edition layout (extracted from BGA; fixed S-die at 1,-2)
        [("C", 6), ("L", 5), ("B", 4), ("S", 3)],
        [("L", 2), ("L", 1), ("B", 6), ("S", 5), ("S", 4)],
        [("B", 5), ("B", 4), ("B", 3), ("S", 1), ("C", 2), ("M", 3)],
        [("L", 6), ("L", 1), ("L", 2), ("Y", 6), ("Y", 5), ("M", 4), ("S", 1)],
    ...
    "5": ("One, Two, Three", [
        ...
        [("B", 6), ("B", 1), ("L", 2), ("Y", 6), ("C", 5), ("B", 4), ("B", 1)],
        [("Y", 2), ("C", 5), ("L", 4), ("Y", 3), ("S", 1), ("B", 2)],
        [("B", 6), ("L", 1), ("B", 2), ("C", 5), ("S", 6)],
        [("Y", 3), ("Y", 4), ("B", 1), ("M", 3)],
    ]),
    "6": ("Big River", [
    ...
    "7": ("Central City", [
        [("Y", 6), ("C", 5), ("C", 4), ("S", 3)],
        [("Y", 2), ("L", 1), ("L", 6), ("L", 5), ("S", 4)],
        [("S", 5), ("M", 4), ("B", 3), ("B", 1), ("M", 2), ("L", 3)],
        [("S", 6), ("Y", 1), ("B", 2), ("B", 6), ("B", 5), ("L", 4), ("B", 1)],
        [("B", 2), ("Y", 5), ("B", 4), ("B", 3), ("L", 1), ("B", 2)],
        [("B", 6), ("S", 1), ("M", 2), ("Y", 5), ("B", 6)],
        [("S", 3), ("C", 4), ("C", 1), ("Y", 3)],
    ]),
    "8": ("Outer Cities", [
        ...
        [("B", 6), ("L", 1), ("Y", 2), ("M", 6), ("L", 5), ("Y", 4), ("B", 1)],
        [("S", 2), ("L", 5), ("L", 4), ("L", 3), ("M", 1), ("B", 2)],
        [("B", 6), ("C", 1), ("L", 2), ("C", 5), ("S", 6)],
        [("B", 3), ("S", 4), ("B", 1), ("B", 3)],
    ]),
    "9": ("Two Cities", [
        [("B", 6), ("B", 5), ("C", 4), ("Y", 3)],
        [("B", 2), ("B", 1), ("L", 6), ("L", 5), ("S", 4)],
        [("B", 5), ("B", 4), ("L", 3), ("L", 1), ("S", 2), ("S", 3)],
        [("C", 6), ("Y", 1), ("Y", 2), ("M", 6), ("S", 5), ("C", 4), ("Y", 1)],
        [("S", 2), ("S", 5), ("Y", 4), ("M", 3), ("B", 1), ("L", 2)],
        [("Y", 6), ("B", 1), ("B", 2), ("B", 5), ("L", 6)],
        [("M", 3), ("C", 4), ("B", 1), ("B", 3)],
    ]),
