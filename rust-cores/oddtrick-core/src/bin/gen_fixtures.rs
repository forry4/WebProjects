...
//!
//! `games/oddtrick/engine.py` is a hand port of `state.rs`. Two independent
...
//! points -- and `games/oddtrick/tests/test_rust_parity.py` replays them and
...
//!
//!   gen_fixtures [games] > games/oddtrick/tests/fixtures/play.jsonl
